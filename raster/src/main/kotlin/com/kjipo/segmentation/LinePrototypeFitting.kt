...
//
//        val topPair = Pair(startPair.first, startPair.second)
//        val topId = 1
...
//
//    val tabooSet = mutableSetOf<Pair<Pair<Int, Int>, Pair<Int, Int>>>()
//
...
//
//
//private fun expandFit(prototypeHistory: MutableList<AngleLine>, distanceMatrix: Matrix<Int>, tabooSet: MutableSet<Pair<Pair, Pair>>, scoreHistory: MutableList<Int>): kotlin.Pair<AngleLine, Int> {
...
//    val distanceMatrix = transformArraysToMatrix(distanceMap)
//
//    val tabooSet = mutableSetOf<Pair<Pair, Pair>>()
//
//    var bestScore = Int.MIN_VALUE
//    var bestPrototype = AngleLine(1, Pair(0, 0), 1.0, 0.0)
...
//
//
//private fun expandFit2(prototype: AngleLine, distanceMatrix: Matrix<Int>, tabooSet: MutableSet<Pair<Pair, Pair>>): kotlin.Pair<AngleLine, Int> {
//    var bestScore = Int.MIN_VALUE
//    var bestPrototype = AngleLine(1, Pair(0, 0), 1.0, 0.0)
//
